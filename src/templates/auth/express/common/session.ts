 ...
 * testHelperAuth
 */
export const indexTypes =  `import type { Session, SessionData } from 'express-session'
...
export const session = `import session from 'express-session'
...
export const sessionTest = `import session from 'supertest'
...
export const testHelperAuth = `import express, {type Request, type Response, } from 'express'
